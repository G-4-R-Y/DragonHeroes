...
3. **R78** — distribution: the 57.16 MB Windows zip heading for GitHub's
   100 MB hard limit. (Its companion R79 — the Windows package that shipped no
   GDExtension — is DONE; the fix is also what pushed the zip to 57.16 MB.)
